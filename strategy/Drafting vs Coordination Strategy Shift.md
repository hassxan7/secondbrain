...
The core product dilemma after talking to industry operators ([[Hesh]], [[Reuben Roy]]): they push **BIM coordination** as the high-value skill and market. Civly's sharper read is to **shift the wedge from coordination to drafting** — generate the first credible BIM draft, and stay out of the clash-detection / Navisworks / ACC coordination war.
...
- Industry advice from [[Hesh]] (BIM Accelerator public teaching + operator worldview) and [[Reuben Roy]] (practitioner conversation)
...
- Reuben's full name, firm, and exact wording need confirmation on [[Reuben Roy]].
