...
Catalog of all pages. Updated on every ingest. Read this first when answering queries.
...
## MEP Knowledge (`pages/MEP/`)

Curated pages distilling MEP knowledge for Civly product development. Only HIGH-relevance MEP sources generate pages here.
...
| Page | Summary |
|------|---------|
| [[Structural Engineering Overview for Civly]] | Column sizing rules, slab depth guide, wall types — what Claude must know for Tapir MCP structural calls |
...
| [[TAM SAM SOM — Global Rebuild (Sep 2026)]] | Global USD market sizing (US$60B / US$9B / US$20M) replacing the AU+NZ set, with derivations + the Gemini image-edit prompt | 2026-09-11 |
...
See [[CRM/index]] for the full contact list.
